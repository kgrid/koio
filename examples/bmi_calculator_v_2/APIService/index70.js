...
export function calculate70(inputs){
	...
	var value = bmi(inputs[config.child_list[71].field],inputs[config.child_list[72].field]);
...
function getConfig() {
    ...
    return {"id": 70, "title": "BMI 计算", "child_list": {"71": {"id": 71, "title": "weight(kg)", "field": "zhyl24", "data_type": 3, "parent_id": 70}, "72": {"id": 72, "title": "height(cm)", "field": "zhyl55", "data_type": 3, "parent_id": 70}}, "result": {}};
